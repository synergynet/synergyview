 ...
 *            the generic type
 */
public abstract class AbstractBaseNode<R> extends PropertySupportObject
		implements INode {
	...
	public void setIconDecorator(String iconDecorator) {
		firePropertyChange(PROP_ICON_DECORATOR, this.iconDecorator,
	...
	public void setLabelDecorator(String labelDecorator) {
		firePropertyChange(PROP_LABEL_DECORATOR, this.labelDecorator,
