...
public class AnalysisSubRipFormatter extends ModelObject implements IAnnotationFormatter {
     ...
     */
    public void read(AnnotationSetNode annotationSetNode, Subject subjectToLoad, InputStream inStream) {
     ...
     */
    public void write(AnnotationSetNode annotationSetNode, Subject subjectToSave, OutputStream outStream) {
	// TODO Auto-generated method stub
