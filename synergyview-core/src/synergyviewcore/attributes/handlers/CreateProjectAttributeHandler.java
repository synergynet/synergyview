 ...
 */
public class CreateProjectAttributeHandler extends AbstractHandler implements IHandler {
	...
	if (window.getPartService().getActivePart() instanceof CodingExplorerViewPart) {
	    CodingExplorerViewPart cPart = (CodingExplorerViewPart) window.getPartService().getActivePart();
