...
public class CodingExplorerViewPart extends ViewPart implements
		ISelectionListener {
	...
	private static class AttributeTextLabelProvider extends
		...
		public void update(ViewerCell cell) {
			if (cell.getElement() instanceof AttributeNode) {
				...
				cell.setImage((Image) resourceManager.get(((INode) node)
						.getIcon()));
			}
	...
	public void createPartControl(Composite parent) {
		...
		attributesViewer = new TreeViewer(composite, SWT.MULTI | SWT.H_SCROLL
				| SWT.V_SCROLL);
		...
		Menu menu = menuManager
				.createContextMenu(attributesViewer.getControl());
	...
	public void selectionChanged(IWorkbenchPart part, ISelection selection) {
		if ((part instanceof ProjectExplorerViewPart)
				&& (selection instanceof IStructuredSelection)) {
			if (!selection.isEmpty()
					&& (selection instanceof IStructuredSelection)
					&& (((IStructuredSelection) selection).getFirstElement() instanceof ProjectNode)) {
				ProjectNode node = (ProjectNode) ((IStructuredSelection) selection)
						.getFirstElement();
				...
				if (!isSticky && (attributesViewer.getInput() != null)) {
					label.setText("No project selected");
					((ProjectAttributeRootNode) attributesViewer.getInput())
							.setTreeViewer(null);
					attributesViewer.setInput(null);
				}
			}
