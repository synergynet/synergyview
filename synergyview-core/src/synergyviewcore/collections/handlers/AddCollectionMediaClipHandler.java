 ...
 */
public class AddCollectionMediaClipHandler extends AbstractHandler implements IHandler {
	...
	if (window instanceof CollectionEditor) {
		...
		MessageDialog.openWarning(window.getSite().getShell(), "No Media found!", "Please add the collection media first.");
	    }
	}
	return null;
    }
