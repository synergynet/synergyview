...
public class Collection extends PersistenceModelObject {
	 ...
	 */
	public void setCollectionMediaClipList(
			List<CollectionMediaClip> collectionMediaClip) {
		this.firePropertyChange(
				PROP_COLLECTION_MEDIA_LIST,
				null,
				Collections
						.unmodifiableCollection(this.collectionMediaClipList = collectionMediaClip));
	}
	...
	public void setCollectionMediaList(List<CollectionMedia> collectionMediaList) {
		this.firePropertyChange(
				...
				null,
				Collections
						.unmodifiableCollection(this.collectionMediaList = collectionMediaList));
	}
	...
	public void setDetails(String details) {
		this.firePropertyChange(PROP_DETAILS, this.details,
	...
	public void setFileName(String fileName) {
		this.firePropertyChange(PROP_FILENAME, this.fileName,
