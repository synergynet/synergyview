...
public abstract class AbstractMediaCollectionControl extends Composite {
    ...
    /**
     * The listener interface for receiving collectionMedia events. The class that is interested in processing a collectionMedia event implements this interface, and the object created with that class is registered with a component using the component's <code>addCollectionMediaListener<code> method. When
	...
	public void propertyChange(final PropertyChangeEvent arg0) {
		...
		public void run() {
		    if (arg0.getSource().hashCode() != ((AbstractMedia) _mediaMap.get(currentListenedMedia.getId())).hashCode()) {
			return;
		    }
