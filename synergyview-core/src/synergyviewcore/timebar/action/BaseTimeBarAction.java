 ...
 */
public abstract class BaseTimeBarAction extends Action implements
	 ...
	 * 
	 * @see
	 * de.jaret.util.ui.timebars.model.ISelectionRectListener#regionRectChanged
	 * (de.jaret.util.ui.timebars.TimeBarViewerDelegate,
	 * de.jaret.util.ui.timebars.model.TBRect)
	 */
	 ...
	 * 
	 * @see
	 * de.jaret.util.ui.timebars.model.ISelectionRectListener#regionRectClosed
	 * (de.jaret.util.ui.timebars.TimeBarViewerDelegate)
	 */
	 ...
	 * 
	 * @see
	 * de.jaret.util.ui.timebars.model.ISelectionRectListener#selectionRectChanged
	 * (de.jaret.util.ui.timebars.TimeBarViewerDelegate,
	 * de.jaret.util.date.JaretDate, de.jaret.util.date.JaretDate,
	 * java.util.List)
	 */
	 ...
	 * 
	 * @see
	 * de.jaret.util.ui.timebars.model.ISelectionRectListener#selectionRectClosed
	 * (de.jaret.util.ui.timebars.TimeBarViewerDelegate)
	 */
