...
public class MediaControlBar extends Composite {
    ...
    /**
     * The listener interface for receiving mediaControl events. The class that is interested in processing a mediaControl event implements this interface, and the object created with that class is registered with a component using the component's <code>addMediaControlListener<code> method. When
