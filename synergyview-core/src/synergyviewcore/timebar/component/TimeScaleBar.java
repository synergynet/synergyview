...
public class TimeScaleBar extends Composite {
    ...
    /**
     * The listener interface for receiving timeScale events. The class that is interested in processing a timeScale event implements this interface, and the object created with that class is registered with a component using the component's <code>addTimeScaleListener<code> method. When
