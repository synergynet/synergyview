 ...
 *
 */
public class VideoWindow extends javax.swing.JComponent {
	private static Logger logger = Logger.getLogger(VideoWindow.class);
	private static final long serialVersionUID = -8916459410626088873L;
    ...
    public VideoWindow() {
        ...
        //
        resourceTimer = new Timer(500, resourceReaper);
    ...
    private void render(Graphics g, int x, int y, int w, int h) {
        ...
        if (!frameRendered) {
            ...
            if (!resourceTimer.isRunning()) {
            	logger.debug("starting resoruce releasing timer");
