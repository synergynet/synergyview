...
public class PlayStopHandler extends AbstractHandler implements IHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		if (page.getActiveEditor() instanceof CollectionMediaClipAnnotationEditor) {
			...
			if (!annotationEditor.getSubtitleMediaControl().isPlaying()) {
				annotationEditor.getSubtitleMediaControl().setPlaying(true);
			} else {
				annotationEditor.getSubtitleMediaControl().setPlaying(false);
			}
		}
		return null;
	}
