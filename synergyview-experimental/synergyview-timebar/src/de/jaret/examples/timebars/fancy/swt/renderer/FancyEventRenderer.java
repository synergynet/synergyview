 ...
 */
public class FancyEventRenderer extends RendererBase implements TimeBarRenderer, TimeBarRenderer2 {
     ...
     */
    public FancyEventRenderer(Printer printer) {
        super(printer);
        _size = scaleX(SIZE);
    }
    ...
    public TimeBarRenderer createPrintrenderer(Printer printer) {
        FancyEventRenderer renderer = new FancyEventRenderer(printer);
        return renderer;
    }
    ...
    private void defaultDraw(GC gc, Rectangle drawingArea, TimeBarViewerDelegate delegate, Interval interval,
        ...
        FancyEvent fe = (FancyEvent) interval;
