 ...
 * 
 * @author Peter Kliem
 * @version $Id: TimeBarRenderer2.java 800 2008-12-27 22:27:33Z kliem $
 */
public interface TimeBarRenderer2 {
     ...
     * 
     * @param delegate timebar viewer delegate
     ...
     */
    String getToolTipText(TimeBarViewerDelegate delegate, Interval interval, Rectangle drawingArea, int x, int y,
            boolean overlapping);
     ...
     */
    boolean contains(TimeBarViewerDelegate delegate, Interval interval, Rectangle drawingArea, int x, int y,
            boolean overlapping);
     ...
     */
    Rectangle getContainingRectangle(TimeBarViewerDelegate delegate, Interval interval, Rectangle drawingArea,
            boolean overlapping);
