 ...
 * 
 * @author Peter Kliem
 * @version $Id: ExpandNodeAction.java 160 2007-01-02 22:02:40Z olk $
 */
public class ExpandNodeAction extends Action {
     ...
     */
    public ExpandNodeAction(TimeBarViewer viewer, TimeBarViewerDelegate delegate) {
        _viewer = viewer;
        _delegate = delegate;
    }
    ...
    public void run() {
        if (_delegate.getHierarchicalViewState() != null) {
            ...
            if (node != null) {
                _delegate.getHierarchicalViewState().setExpandedRecursive(node, true);
            }
        }
    }
