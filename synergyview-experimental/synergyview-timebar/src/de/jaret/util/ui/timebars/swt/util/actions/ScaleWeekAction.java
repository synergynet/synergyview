 ...
 * 
 * @author Peter Kliem
 * @version $Id: ScaleWeekAction.java 160 2007-01-02 22:02:40Z olk $
 */
public class ScaleWeekAction extends Action {
     ...
     */
    public ScaleWeekAction(TimeBarViewer viewer, TimeBarViewerDelegate delegate) {
        _viewer = viewer;
        _delegate = delegate;
    }
    ...
    public void run() {
        ...
        double pps = (double) width / (7.0 * 24.0 * 60.0 * 60.0);
