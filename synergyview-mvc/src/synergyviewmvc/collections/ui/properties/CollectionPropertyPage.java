package synergyviewmvc.collections.ui.properties;
...
public class CollectionPropertyPage extends PropertyPage {
	...
	// private Composite previewContainer = null;

	private Text _collectionNameText;
	private Text _collectionDetailsText;
	private Collection _collection;
	private CollectionNode _collectionNode;
	private DataBindingContext _collectionModelBindingCtx = new DataBindingContext();
	...
	@Override
	public void dispose() {
		if (_collectionModelBindingCtx!=null)
			_collectionModelBindingCtx.dispose();
		super.dispose();
	}
	...
	protected Control createContents(Composite parent) {
		...
		_collectionNode = (CollectionNode) this.getElement();
		_collection = _collectionNode.getResource();
	...
	private void addSectionDetails(Composite composite) {
		...
		_collectionModelBindingCtx.bindValue(SWTObservables.observeText(
	...
	private void saveCollectionData() {
		_collectionModelBindingCtx.updateModels();
		_collectionNode.updateResource();
	}

	@Override
	protected void performDefaults() {
		_collectionModelBindingCtx.updateTargets();
