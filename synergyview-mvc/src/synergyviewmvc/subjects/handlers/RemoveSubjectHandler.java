/**
 *  File: RemoveSubjectHandler.java
 *  Copyright (c) 2010
 *  phyo
 *
 ...
 *
 */
public class RemoveSubjectHandler extends AbstractHandler implements IHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		if (element instanceof SubjectNode) {
			...
			((SubjectsRootNode) subjectNode.getParent()).removeChildCollectionNode(subjectNode);
		}
		return null;
	}
