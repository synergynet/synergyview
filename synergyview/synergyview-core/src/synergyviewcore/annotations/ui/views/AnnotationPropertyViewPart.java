...
public class AnnotationPropertyViewPart extends ViewPart implements ISelectionListener, CollectionChangeListener {
	...
	public void createPartControl(Composite parent) {
		...
		annotationText = new Text(composite,SWT.WRAP
		          | SWT.MULTI
		          | SWT.BORDER
		          | SWT.H_SCROLL
		...
		attributeTableViewer = new TableViewer(composite, SWT.MULTI | SWT.H_SCROLL
	...
	private void updateData(AnnotationAttributeController selectedController) {
		...
		//Getting different set of attributes because controller attribute list is different
		//TODO fix!!!
