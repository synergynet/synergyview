...
public class CollectionPropertyPage extends PropertyPage {
	...
	private void addSectionDetails(Composite composite) {
		...
		collectionModelBindingCtx.bindValue(SWTObservables.observeText(
				_collectionNameText, SWT.Modify), BeansObservables
				.observeValue(_collection, Collection.PROP_NAME),
		...
		collectionModelBindingCtx.bindValue(SWTObservables.observeText(
				_collectionDetailsText, SWT.Modify), BeansObservables
				.observeValue(_collection, Collection.PROP_DETAILS),
				new UpdateValueStrategy(UpdateValueStrategy.POLICY_ON_REQUEST),
				null);
