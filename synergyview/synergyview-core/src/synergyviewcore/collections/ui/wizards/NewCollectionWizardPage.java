...
public class NewCollectionWizardPage extends WizardPage {
	 ...
	 */
	public NewCollectionWizardPage(Collection collectionVAlue,
			List<String> existingCollectionNameValues) {
		...
		setDescription(ResourceLoader
				.getString("DIALOG_DESCRIPTION_START_PAGE_SESSION"));
	}
	...
	private void bindValues() {
		...
		bind(nameText, collection, Collection.PROP_NAME,
