...
public class MediaSegmentIntervalImpl extends IntervalImpl {
	 ...
	 *            the owner
	 */
	public MediaSegmentIntervalImpl(JaretDate begin, JaretDate end,
			CollectionNode collectionNode,
			CollectionMediaClip collectionMediaClip,
			CollectionMediaClipRowModel owner) {
		super(begin, end);
	 ...
	 */
	public void dispose() {
		collectionMediaClip.removePropertyChangeListener(
				CollectionMediaClip.PROP_CLIP_NAME, listener);
	}
	...
	private void init() {
		...
		listener = new PropertyChangeListener() {
			...
			public void propertyChange(PropertyChangeEvent arg0) {
				MediaSegmentIntervalImpl.this.setLabel(collectionMediaClip
						.getClipName());
			}
			
		};
		collectionMediaClip.addPropertyChangeListener(
				CollectionMediaClip.PROP_CLIP_NAME, listener);
	}
